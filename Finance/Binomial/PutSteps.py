#Step 6 - User input for American Put/Call, continuous as per Black-Scholes model
...
CallOptionLattice = deepcopy(StockLattice)
...
PutOptionLattice = deepcopy(StockLattice)
